...
<body class="bg-animated">
    <div class="w-screen h-screen flex justify-center items-center">
        <form action="register.php" method="post" class="bg-white p-6 rounded-sm flex flex-col gap-4 shadow-lg" enctype="multipart/form-data">
            <div class="flex flex-col gap-2">
                <label class="text-md text-neutral-700 font-semibold" for="">Foto de perfil</label>
                <input class="focus:outline-none focus:border-neutral-400 text-neutral-700 file:border-none file:bg-purple-500 file:text-white file:px-4 file:py-2 cursor-pointer file:cursor-pointer text-xl border border-neutral-300 rounded-sm" required autocomplete="off" type="file" name="profile" id="" accept="image/png" placeholder="Foto de perfil">
            </div>
            <div class="flex flex-col gap-2">
